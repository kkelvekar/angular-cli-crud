...
var generic_validator_1 = require("../shared/helpers/generic-validator");
var number_validator_1 = require("../shared/helpers/number-validator");
var ProductEditComponent = (function () {
    function ProductEditComponent(currentRoute, router, fb, productService, cdRef) {
    ...
    ProductEditComponent.prototype.ngAfterViewChecked = function () {
    ...
    ProductEditComponent.prototype.onReleaseDateSelected = function () {
        this.displayCalender = false;
        var selectedDate = this.productForm.get('calenderReleaseDate').value;
        this.productForm.patchValue({
